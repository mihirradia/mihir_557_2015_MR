...
public:
	...
	bool key_callback1(int _change_key);
	bool key_callback2(int _change_key);
	bool key_callback3(int _change_key);
	bool key_callback4(int _change_key);
...
protected:
	...
	int check_key = 0, check_key2 = 0, check_key3 = 0, check_key4 = 0;
