...
int main(int argc, const char * argv[])
{
   ...
   // apperance_0->addLightSource(light_source);
    ...
    spotlight_source._diffuse_intensity = 1.0;
    ...
    material_0._diffuse_material = glm::vec3(0.2, 0.5, 1.0);
    material_0._ambient_material = glm::vec3(1.0, 1.0, 0.0);
    ...
    int texid = texture->loadAndCreateTexture("../../data/textures/skyline-new-york-city.bmp");
